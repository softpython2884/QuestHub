...
export const projects = [
  ...
  },
  {
    slug: "simubourse",
    name: "SimuBourse",
    shortDescription: "Un jeu de simulation de business et de bourse à grand réalisme, disponible sur le web et en PWA.",
    longDescription: `SimuBourse est une simulation économique profonde où chaque action a des conséquences. En tant que joueur, vous pouvez créer vos propres entreprises à partir de zéro, investir dans celles de vos concurrents, spéculer sur les marchés boursiers, et même vous lancer dans le minage de cryptomonnaies. Le but est de construire un empire financier en prenant des décisions stratégiques, en gérant vos actifs et en naviguant dans un monde économique dynamique et réaliste.`,
    image: "https://placehold.co/800x600.png",
  ...
  },
  {
    slug: "space",
    name: "Space",
    shortDescription: "Un jeu .io de gestion et de stratégie spatiale, jouable en solo ou en multijoueur.",
    longDescription: `Space est un jeu de stratégie en temps réel qui vous met aux commandes d'une base stellaire. Votre mission : survivre et conquérir. Pour cela, vous devrez miner des ressources sur les astéroïdes, développer votre base, construire des flottes de vaisseaux, et établir des avant-postes pour défendre votre territoire. Explorez une carte générée de manière procédurale, affrontez d'autres joueurs ou des IA, et utilisez la tactique pour anéantir les bases ennemies et devenir le maître de la galaxie.`,
    image: "https://placehold.co/800x600.png",
  ...
  },
  {
    slug: "nation-quest",
    name: "Nation Quest",
    shortDescription: "Un serveur Minecraft MMORPG moddé en 1.20.1, axé sur la construction de nations, la diplomatie et l'aventure.",
    longDescription: `Nation Quest transforme Minecraft en un véritable MMORPG. Le projet s'articule autour d'un système de compétences complexe, d'armes et d'armures uniques avec des statistiques variées, et d'un monde riche en histoire et en quêtes scénarisées. Les joueurs peuvent fonder leurs propres nations, gérer des territoires, s'engager dans la diplomatie ou la guerre, et participer à une économie globale, le tout dans un univers persistant et en constante évolution.`,
    image: "https://placehold.co/800x600.png",
