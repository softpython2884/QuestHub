...
Based on the user's prompt, generate a list of tasks. For each task, provide a clear title, a short description, and an optional checklist of sub-tasks.
...
Example of a good 'todoListMarkdown' field:
