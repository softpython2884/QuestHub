...
//Credits: http://glslsandbox.com/e#60836.0
...
uniform float u_star1Count;
uniform float u_star2Count;
uniform float u_loop1;
uniform float u_loop2;
...
{	
	...
	vec4 starcolor = vec4(pow(rnd.y, u_star1Count));
	
	//Second Layer
	vec2 seed2 = p2.xy * 2.0;
	seed2 = floor(seed2 * u_resolution.x);
	vec3 rnd2 = nrand3( seed2 );
	starcolor += vec4(pow(rnd2.y, u_star2Count));
